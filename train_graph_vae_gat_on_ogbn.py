...
from dataloader_graph_emb_gat import load_graph_emb_dataset, load_large_graph_emb_dataset, load_graph_emb_dataset_ogbn
...
def train(params:argparse.Namespace):
    ...
    dataloader, dataset = load_graph_emb_dataset_ogbn(params)
    ...
    with tqdm(dataloader, dynamic_ncols=True) as tqdmDataLoader:
        for i in range(1):
            feature_emb_gt = dataset.feat_embs_norm
            normalized_adj = dataset.norm_adj
            neighbor_map_gt = dataset.neighbor_map_gt
            labels = dataset.labels
            positional_embeddings = dataset.positional_embeddings
...
def main():
    ...
    parser.add_argument('--neighbor_map_dim',type=int,default=1412, help='neighbor map dimension,number of dataset nodes')    
